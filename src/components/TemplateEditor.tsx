      ...
      <div className="grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div
              className="rounded-2xl overflow-hidden border border-gray-200 bg-center bg-cover p-8"
              style={{ backgroundImage: `url(${backgroundUrl || ''})` }}
            >
              <div className="bg-white/85 backdrop-blur-sm rounded-xl p-6 space-y-4">
                {textLines.map((line) => (
                  <p
                    key={line.id}
